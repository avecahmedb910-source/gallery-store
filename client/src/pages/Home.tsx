      ...
      <header className="sticky top-0 z-30 border-b border-[#eadfd3] bg-[var(--brand-surface)]/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[var(--brand-copper)] text-lg font-black text-white shadow-lg shadow-[#c58b65]/20">M</div>
      ...
      <main>
        <section className="relative overflow-hidden bg-[var(--brand-sand)]">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 md:grid-cols-[1fr_0.9fr] md:px-8 md:py-24">
            ...
            <div className="relative mx-auto w-full max-w-md"><div className="aspect-square rounded-[3rem] bg-[#d1b198] shadow-2xl shadow-[#8e5c46]/20"/><div className="absolute inset-8 flex items-center justify-center rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-[#f9f3ed] to-[#c58b65] p-8 text-center shadow-xl"><div><div className="text-6xl font-black text-[var(--brand-plum)]/90">G</div><div className="mt-3 text-xl font-black tracking-[0.2em] text-[var(--brand-plum)]">GALLERY</div><div className="mt-1 text-xs font-bold tracking-[0.35em] text-[var(--brand-plum)]/60">STORE</div></div></div><div className="absolute -bottom-5 -right-4 rounded-2xl bg-white px-5 py-4 text-sm font-black shadow-xl">هدية تفرّح من أول نظرة ✦</div></div>
          </div>
        </section>
